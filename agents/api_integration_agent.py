...
class APIIntegrationAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "  3. src/hooks/use<X>.ts     — One custom hook per resource group (SWR or\n"
            "                               React Query; Pinia composable for Vue)\n\n"
            "Rules:\n"
            ...
            "- Use SWR for React/Next.js data fetching hooks; use Vue composables for Vue.\n"
