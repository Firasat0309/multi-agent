...
class ArchitectAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "- For Java/Spring Boot: The @SpringBootApplication main class MUST be in the ROOT\n"
            "  package (common parent of all sub-packages). Example: if services are in\n"
            "  com.example.auth.service and models in com.example.auth.models, the main class\n"
            "  MUST be in com.example.auth (i.e. src/main/java/com/example/auth/Application.java).\n"
            "  Place it in a sub-package and Spring will NOT scan sibling packages.\n"
