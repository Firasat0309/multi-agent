...
class ComponentPlannerAgent(BaseAgent):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "    You MUST include an 'App' component with file_path 'src/App.vue',\n"
            "    component_type 'layout'. This is the root application shell that\n"
            "    wraps <RouterView/> and provides global navigation/providers.\n"
            "    Every page component should be listed in App's children.\n"
            "- If framework=nextjs:\n"
